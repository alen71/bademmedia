...
import PresentationSlider from '@/components/shared/PresentationSlider'
import AnimatedIMagesWrapp from '@/components/shared/AnimatedIMagesWrapp'
import AnimatedParagraph from '@/components/shared/AnimatedParagraph'
import ProductsReadMoreBtn from '@/components/shared/ProductsReadMoreBtn'
...
import redChair1 from '/public/images/Klijenti/SIT FORM/fotke/red-chair-1.png'
import redChair2 from '/public/images/Klijenti/SIT FORM/fotke/red-chair-2.png'
import redChair3 from '/public/images/Klijenti/SIT FORM/fotke/red-chair-3.png'
import whiteChair1 from '/public/images/Klijenti/SIT FORM/fotke/white-chair-1.png'
import whiteChair2 from '/public/images/Klijenti/SIT FORM/fotke/white-chair-2.png'
...
const Sitform = ({ images, videos }: IProducts) => {
  ...
  return (
    <PageLayout
      title={t('sitform:metaTitle')}
      desc={t('sitform:metaDesc')}
      noindex
    >
        ...
        <div className="h-fit max-w-[74rem] mx-auto grid grid-cols-2 gap-x-3 sm:gap-x-6 md:gap-x-10 mt-24 sm:mt-36 md:mt-44 px-6 md:px-[4.3rem] relative z-[1]">
          ...
          <div className="grid grid-rows-[55fr_45fr] gap-y-3 sm:gap-y-6 md:gap-y-10 h-full">
            <div className="relative h-full w-full">
              <AnimatedIMagesWrapp className="w-full h-full">
                <Image
                  src={redChair3}
                  alt="red chair 3"
